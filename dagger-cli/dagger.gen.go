...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "DaggerCli":
		...
		case "ContainerEcho":
			...
			return (*DaggerCli).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent DaggerCli
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*DaggerCli).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("DaggerCli").
					WithFunction(
